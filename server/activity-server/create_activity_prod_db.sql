...
CREATE TABLE activity_test (
    ...
    closed_circuit_hearing_loop_available BOOLEAN,
    additional_charge BOOLEAN,
    accommodate_service_animals BOOLEAN,
...
onsite_childcare) values('Plant Flowers', cast('2019-04-15' as date), numrange(12.0, 15.0), money(21.50), 
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Seattle Basketball', '2019-03-27'::date, numrange('(10.5,16.75)'), money('10.5'),
'5613 NE 139th Street', 'Seattle', 'WA', 'US', '98105'::integer, '(425)643-4329', 'We will be playing basketball on March 27th, 2019!!!!',
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Bellevue Soccer', '2019-03-16'::date, numrange('(16.00,18.00)'), money('12.5'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Bird Watching', '2019-03-27'::date, numrange('(8.5,16.00)'), money('15.00'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Yoga Fire', '2019-03-09'::date, numrange('(18.0,22.0)'), money('30.00'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Drum with Nicolas', '2019-03-21'::date, numrange('(18.00,20.00)'), money('19.99'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Dessert Tasting', '2019-03-18'::date, numrange('(11.0,15.0)'), money('24.99'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Beauty of Art', '2019-03-25'::date, numrange('(9.00,16.00)'), money('20.00'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Hackathon', '2019-04-01'::date, numrange('(8.00,24.00)'), money('25.00'),
...
equipment_provided, sibling_participation, kids_to_staff_ratio, asl_interpreter_available,
closed_circuit_hearing_loop_available, additional_charge, accommodate_service_animals,
onsite_childcare) values('Exhibition of Capsi Anat', '2019-03-30'::date, numrange('(8.0,18.00)'), money('14.99'),
